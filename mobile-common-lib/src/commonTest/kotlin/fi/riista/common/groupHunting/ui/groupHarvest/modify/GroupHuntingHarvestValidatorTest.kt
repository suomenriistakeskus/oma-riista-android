...
import fi.riista.common.groupHunting.ui.groupHarvest.GroupHuntingHarvestFields
import fi.riista.common.model.*
import kotlin.random.Random
import kotlin.test.Test
import kotlin.test.assertEquals

class GroupHuntingHarvestValidatorTest {
    ...
    fun testValidData() {
        ...
        val errors = GroupHuntingHarvestValidator.validate(
                context.harvest,
                createHuntingDays(),
                createPermit(),
                displayedFields
    ...
    fun testNoSpecimens() {
        assertValidationError(
                expectedError = GroupHuntingHarvestValidator.Error.MISSING_SPECIMEN,
    ...
    fun testDateNotWithinPermit_Deer() {
        assertValidationError(
                expectedError = GroupHuntingHarvestValidator.Error.DATE_NOT_WITHIN_GROUP_PERMIT,
                harvest = createHarvest(),
                speciesCodes = listOf(
                        SpeciesCodes.FALLOW_DEER_ID,
                        SpeciesCodes.ROE_DEER_ID,
    ...
    fun testHuntingDay_Moose() {
        assertValidationError(
                expectedError = GroupHuntingHarvestValidator.Error.MISSING_HUNTING_DAY,
    ...
    fun testTimeNotWithinHuntingDay_Moose() {
        assertValidationError(
                expectedError = GroupHuntingHarvestValidator.Error.TIME_NOT_WITHIN_HUNTING_DAY,
    ...
    fun testActor() {
        assertValidationError(
            expectedError = GroupHuntingHarvestValidator.Error.MISSING_ACTOR,
    ...
    fun testGender_null() {
        assertValidationError(
                expectedError = GroupHuntingHarvestValidator.Error.MISSING_GENDER,
    ...
    fun testAge_null() {
        assertValidationError(
                expectedError = GroupHuntingHarvestValidator.Error.MISSING_AGE,
    ...
    fun testAlone_Moose() {
        assertValidationError(
                expectedError = GroupHuntingHarvestValidator.Error.MISSING_ALONE,
    ...
    fun testNotEdible_errors() {
        assertValidationError(
                expectedError = GroupHuntingHarvestValidator.Error.MISSING_NOT_EDIBLE,
    ...
    fun testAntlersLost() {
        assertValidationError(
                expectedError = GroupHuntingHarvestValidator.Error.MISSING_ANTLERS_LOST,
    ...
    private fun assertValidationError(
        expectedError: GroupHuntingHarvestValidator.Error,
        harvest: GroupHuntingHarvestData = createHarvest(),
        ...
        speciesCodes.forEach { speciesCode ->
            val errors = getValidationErrors(
                    harvest.copy(gameSpeciesCode = speciesCode), permit, huntingDays)
    ...
    ): List<GroupHuntingHarvestValidator.Error> {
        val context = harvestContext(harvest)

        val displayedFields = GroupHuntingHarvestFields.getFieldsToBeDisplayed(context)
        return GroupHuntingHarvestValidator.validate(context.harvest, huntingDays, permit, displayedFields)
    }

    private fun harvestContext(harvest: GroupHuntingHarvestData = createHarvest()) =
    ...
    private fun createHarvest(
        specimen: HarvestSpecimen? = createSpecimen(),
        ...
        return GroupHuntingHarvestData(
                ...
                imageIds = listOf(),
                specimens = listOfNotNull(specimen),
                ...
                // using random should be fine as long as we don't change it at any point
