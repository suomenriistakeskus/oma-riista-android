...
internal class GroupObservationStringWithIdEventToIntentMapper(
    ...
    override fun dispatchStringWithIdChanged(fieldId: GroupObservationField, value: StringWithId) {
        val intent = when (fieldId) {
            GroupObservationField.ACTOR -> GroupObservationIntent.ChangeActor(value)
            else -> {
