        ...
        dataFieldProducers = listOf(
                { state: SelectionState? ->
                    ...
                    StringListField(
                            ...
                            selected = state?.clubContext?.club?.id
                    ) {
                ...
                { state: SelectionState? ->
                    ...
                    StringListField(
                            ...
                            selected = state?.huntingGroupFilter?.selectedHuntingYear?.toLong()
                    ) {
                ...
                { state: SelectionState? ->
                    ...
                    StringListField(
                            ...
                            selected = state?.huntingGroupFilter?.selectedSpecies?.toLong()
                    ) {
                ...
                { state: SelectionState? ->
                    ...
                    StringListField(
                            ...
                            selected = state?.huntingGroupFilter?.selectedHuntingGroup?.id
                    ) {
                    ...
                    state?.huntingGroupFilter?.selectedHuntingGroup
                        ?.let {
                            val permitNumber = stringProvider.getFormattedString(
                                    RR.string.group_hunting_label_permit_formatted,
