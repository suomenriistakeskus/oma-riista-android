...
internal class FetchHuntingGroupStatus(
    private val huntingGroupId: HuntingGroupId,
): NetworkRequest<HuntingGroupStatusDTO> {
    override suspend fun request(client: NetworkClient): NetworkResponse<HuntingGroupStatusDTO> {
        return client.request(
                request = {
                    get(urlString = "${client.serverBaseAddress}/api/mobile/v2/grouphunting/$huntingGroupId/status") {
