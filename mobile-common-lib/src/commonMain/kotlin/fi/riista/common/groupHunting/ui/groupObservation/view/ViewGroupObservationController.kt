...
import fi.riista.common.groupHunting.ui.ObservationActionResolver
...
class ViewGroupObservationController(
    ...
    private fun createViewModel(observationData: GroupHuntingObservationData,
    ...
    private fun initializeFieldProducers() {
        dataFieldProducers = listOf(
            { observation: GroupHuntingObservationData ->
                LocationField(GroupObservationField.LOCATION, observation.geoLocation) {
                    readOnly = true
                }
            },
            { observation: GroupHuntingObservationData ->
                SpeciesCodeField(GroupObservationField.SPECIES_CODE, observation.gameSpeciesCode) {
                    readOnly = true
                }
            },
            { observation: GroupHuntingObservationData ->
