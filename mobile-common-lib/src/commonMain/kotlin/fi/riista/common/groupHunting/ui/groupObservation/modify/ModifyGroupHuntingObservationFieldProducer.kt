...
import fi.riista.common.groupHunting.model.isMember
import fi.riista.common.groupHunting.ui.GroupObservationField
import fi.riista.common.groupHunting.ui.groupHarvest.modify.toStringWithId
import fi.riista.common.groupHunting.ui.groupHarvest.modify.toStringWithIdList
import fi.riista.common.model.SpeciesConstants
...
internal class ModifyGroupHuntingObservationFieldProducer(
    ...
    private fun speciesCode(
        fieldSpecification: FieldSpecification<GroupObservationField>,
        observation: GroupHuntingObservationData,
    ): SpeciesCodeField<GroupObservationField> {
        return SpeciesCodeField(fieldSpecification.fieldId, observation.gameSpeciesCode) {
            readOnly = true
    ...
    private fun location(
        ...
        return LocationField(fieldSpecification.fieldId, observation.geoLocation) {
            readOnly = false
            requirementStatus = fieldSpecification.requirementStatus
        }
    }
