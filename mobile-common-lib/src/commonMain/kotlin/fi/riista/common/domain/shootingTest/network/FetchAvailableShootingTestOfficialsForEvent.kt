...
class FetchAvailableShootingTestOfficialsForEvent(
    ...
    override suspend fun request(client: NetworkClient): NetworkResponse<ShootingTestOfficialsDTO> {
        val url = "${client.serverBaseAddress}/api/mobile/v2/shootingtest/event/$shootingTestEventId/qualifyingofficials/"
